...
subtitle: "Beyond accountability toward performance management"
...
# {background-image=assets/img/processes_versus_outcomes.png background-size="contain" background-position="center"}

---

<h2>Outcomes, outcomes, outcomes</h2>

:::: {.columns}

::: {.column width="50%"}
<p style="font-size: 2em; text-align: center; margin-top: 2.0em;">We live in a society obsessed with ends</p>
:::
...
<h2>A Focus on Outcomes</h2>

**(at the expense of a focus on process)**

<table style="width: 80%; margin: 1.5em auto; font-size: 1.1em; border-collapse: separate; border-spacing: 0 0.6em;">
<tr>
  <td style="text-align: right; width: 40%;"><strong>Process</strong></td>
  <td style="text-align: center; width: 20%; font-size: 0.7em;">vs.</td>
  <td style="text-align: left; width: 40%;"><strong>Product</strong></td>
</tr>
<tr>
  <td style="text-align: right;"><strong>Means</strong></td>
  <td style="text-align: center; font-size: 0.7em;">vs.</td>
  <td style="text-align: left;"><strong>Ends</strong></td>
</tr>
<tr>
  <td style="text-align: right;"><strong>Journey</strong></td>
  <td style="text-align: center; font-size: 0.7em;">vs.</td>
  <td style="text-align: left;"><strong>Destination</strong></td>
</tr>
<tr>
  <td style="text-align: right;"><strong>Development</strong></td>
  <td style="text-align: center; font-size: 0.7em;">vs.</td>
  <td style="text-align: left;"><strong>Result</strong></td>
</tr>
<tr>
  <td style="text-align: right;"><strong>Learning</strong></td>
  <td style="text-align: center; font-size: 0.7em;">vs.</td>
  <td style="text-align: left;"><strong>Attainment</strong></td>
</tr>
<tr>
  <td style="text-align: right;"><strong>Growth</strong></td>
  <td style="text-align: center; font-size: 0.7em;">vs.</td>
  <td style="text-align: left;"><strong>Achievement</strong></td>
</tr>
</table>
...
## {background-image=assets/img/arthur_ashe.png background-size="contain" background-position="center"}
...
<h2>What can Sports teach us about accountability?</h2>

:::{.fragment}
- What is the single indicator used to judge the quality of a sports team? 
:::

::: {.fragment}
<p style="text-align: center; font-size: 2em; margin-top: 1em; color: #4CAF50;"><strong>Wins & Losses</strong></p>
:::

:::{.fragment}
- Every NFL/NBA/NHL/MLB/... coach knows that their future employment is contingent on wins and losses. 
:::


::: {.fragment}
<p style="text-align: center; font-size: 2em; margin-top: 1em; color: #4CAF50;"><strong>However...</strong></p>
:::

:::{.fragment}
- The most effective coaching involves a focus on process: a player learning their role in a game that gives the team the best chance to win.
- In fact, having players attempt ill-advised plays in order to win is the last thing a coach wants to see. 
:::
...
:::{.fragment}
- In education, wins and losses are analogous to proficient and non-proficient students.
- Public perception -- in some part based upon current accountability system reporting -- reflects this in the weight that student achievement (i.e., proficiency) is given.
:::

:::{.fragment}
- Unlike in sports, outcomes, as opposed to process, is often the motivating indicator: "Increase proficiency rates!"
:::

---

<p style="text-align: center; font-size: 2em; margin-top: 1em; color: #4CAF50;"><strong>When accountability systems prioritize proficiency above all else, how do rational, strategic thinking school principals or district leaders respond?  </strong></p>

---

<p style="text-align: center; font-size: 2em; margin-top: 1em; color: #4CAF50;"><strong>Focus on Bubble Kids!</strong></p>

:::{.fragment}
- The focus on bubble kids is a rational response to the accountability system that prioritizes proficiency above all else.
- A maladaptive response just like the ill-advised plays in sports that follow from a focus on wins and losses divorced from process. 
:::

---

## {background-image=assets/img/saban_quote_2.png background-size="contain" background-position="center"}
...
- Not surprisingly, annual state reporting of summative assessment results center around these two challenges.
- There are obviously many educational challenges related to inputs and process that impact these outputs. Without jumping ahead too far, in general I'm skeptical of the incorporation of inputs (process indicators) as a solution to the current accountability conundrum -- rearranging the deck chairs on the Titanic.
:::
...
1. The presumption that educational accountability -- specifically the public reporting of summative assessment results -- is an adequate and acceptable response to the challenge of chronic underperformance and large achievement gaps. 
...
- Extensive research [e.g., @Koretz:2017; @BrykEtal:2015] has shown that without meaningful analytic and organizational support, high-stakes ratings often result in defensive behavior (e.g., narrowing curriculum, gaming metrics) rather than sustained capacity-building.
...
<br><br>
— Christopher Edley Jr. [-@Edley:2006]</h2>
...
URL <- "https://dbetebenner.github.io/WERA_Conference_121025/Death_to_Proficiency_Long_Live_Proficiency.html#/section"
